<div class="col-md-8 col-xl-6 chat" style="position: fixed;right: 0px;width: 30%;top: 500px;height: 50px">
    <div class="card" style="border: 1px solid black">
        <div class="card-body msg_card_body" id="data">
            @foreach($data1 as $item)
                <div class="d-flex justify-content-start mb-4">
                    <div class="msg_cotainer">
                        <span style="color: red">{{$item->author}} :</span>
                    </div>
                    <div id="contentshow" style="padding-left: 20px" class="msg_cotainer">
                        {{$item->content}}
                    </div>
                </div>
            @endforeach
