...
@section('content')
<form id="create-menu" action="{{action('Admin\ChatZaloController@store')}}"  method="post">
    {{ csrf_field() }}
    <!-- Start Content-->
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <label for="projectname">{{trans('message.name_zalo')}}</label>
                                    <input type="text" value="{{old('zalo-name')}}" id="zaloname" name="zalo_name" class="form-control" />
                                </div>
