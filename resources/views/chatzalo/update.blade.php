...
@section('content')
<form id="update-user" action="{{action('Admin\ChatZaloController@update')}}"  method="post">
    {{ csrf_field() }}
    <!-- Start Content-->
                        ...
                        <div class="row">
                            <div class="col-xl-9">
                                <div class="form-group">
                                    <label for="zalo_name">{{trans('message.name_zale')}}</label>
                                    <input type="text" value="{{$data->zalo_name}}" id="zalo_name" name="zalo_name" class="form-control" />
                                </div>
